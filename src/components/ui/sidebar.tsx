		...
		<div
			...
			<div
				...
				<div
					...
					className='bg-sidebar/80 inset-shadow-[0px_0px_32px] inset-shadow-border/50 group-data-[variant=floating]:border-input flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm'>
					{children}
				</div>
			</div>
		</div>
