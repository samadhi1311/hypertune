	...
	return (
		<div
			...
			<div
				...
				className={cn(
					'fixed inset-y-0 z-10 hidden bottom-34 w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex',
					side === 'left'
				...
				<div
					...
					className='bg-sidebar/20 inset-shadow-[0px_0px_32px] inset-shadow-border/50 group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm'>
					{children}
				</div>
			</div>
		</div>
